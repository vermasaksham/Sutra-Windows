 ...
 * the actual fact.
 *
 * Lives in the context panel, which owns the spacing between its sections and
 * is itself never printed: this is a way of getting somewhere else, and on
 * paper there is nowhere else to get to.
 */
